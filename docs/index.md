...
## Latest release: v1.0.8.0

[Download the ARM Developer Mode sideload package](https://github.com/ZuneTracks/YourTube-UWP/releases/tag/v1.0.8.0)

The `v1.0.8.0` release adds a rotating live tile:
